...
class CoNLL14Info(DatasetInfo):
    ...
    splits = {
        "test": SplitInfo(
            file_path=os.path.join(DATA_DIR, "conll2014.test.detok.orig"),
            ref_file_path=os.path.join(REF_DIR, "conll2014.2.test.auto.m2"),
            cor_file_path=[
                os.path.join(COR_DIR, "conll2014.0.test.detok.cor"),
                os.path.join(COR_DIR, "conll2014.1.test.detok.cor"),
            ],
        ),
    }
...
class NewDataset(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        split_generators = []
        for split, split_info in CoNLL14Info.splits.items():
