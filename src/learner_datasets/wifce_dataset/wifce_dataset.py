...
class WIFCEInfo(DatasetInfo):
    ...
    splits = {
        "train2000": SplitInfo(
            file_path=os.path.join(DATA_DIR, "train.detok.n2000.orig"),
            ref_file_path=os.path.join(REF_DIR, "train.auto.n2000.m2"),
            cor_file_path=os.path.join(COR_DIR, "train.detok.n2000.cor"),
        ),
    }
...
_DESCRIPTION = """\
A dataset of 2000 sentences from English as a second language learners.
The dataset is created by uniformly sampled 1000 sentences from FCE-train, 
and 1000 sentences from W&I+LOCNESS train.
"""
...
class NewDataset(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        split_generators = []
        for split, split_info in WIFCEInfo.splits.items():
